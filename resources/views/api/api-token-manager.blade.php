<div>
    ...
    <x-dialog-modal wire:model="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            ...
            <x-button.primary class="ml-3" wire:click="updateApiToken" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-button.primary>
        </x-slot>
    </x-dialog-modal>
    ...
    <x-confirmation-modal wire:model="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            ...
            <x-button.warning class="ml-3" wire:click="deleteApiToken" wire:loading.attr="disabled">
                {{ __('Delete') }}
            </x-button.warning>
        </x-slot>
